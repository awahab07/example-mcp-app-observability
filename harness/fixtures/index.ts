...
import { apmServiceMapFixtures } from "./apm-service-map";
...
import { App as ApmServiceMapApp } from "../../src/views/apm-service-map/App";
...
export const VIEWS: ViewEntry[] = [
  ...
  { slug: "apm-service-map",          label: "APM service map",          Component: ApmServiceMapApp,           fixtures: apmServiceMapFixtures,           defaultState: "incidentFrontendWeb" },
